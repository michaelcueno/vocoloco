...
\item 
\hypertarget{classHttpManager_a3b01fbca81f84123c6a7f42c28aa950b}{void {\bfseries new\-Convo\-Id\-Changed} ()}\label{classHttpManager_a3b01fbca81f84123c6a7f42c28aa950b}

\item 
\hypertarget{classHttpManager_af7cf956c8d5030868461822967a3fa14}{void {\bfseries error} ()}\label{classHttpManager_af7cf956c8d5030868461822967a3fa14}

\item 
\hypertarget{classHttpManager_ab831af38fd5b6ce97c2c6beb6121e492}{void {\bfseries reply\-Finished} ()}\label{classHttpManager_ab831af38fd5b6ce97c2c6beb6121e492}

\item 
\hypertarget{classHttpManager_a2f40bfdca452129a4a8e027a77eaa5df}{void {\bfseries convo\-Created\-Signal} ()}\label{classHttpManager_a2f40bfdca452129a4a8e027a77eaa5df}
...
Adds a user to the conversation that will be sent to the server vai P\-O\-S\-T \hypertarget{classHttpManager_a7dd56984ebb6adbad298a755c0b4d66a}{\index{Http\-Manager@{Http\-Manager}!authenticate@{authenticate}}
\index{authenticate@{authenticate}!HttpManager@{Http\-Manager}}
\subsubsection[{authenticate}]{\setlength{\rightskip}{0pt plus 5cm}void Http\-Manager\-::authenticate (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [slot]}}}\label{classHttpManager_a7dd56984ebb6adbad298a755c0b4d66a}
This method determines if the login post was a success or failure and emits the corresponding signals T\-O\-D\-O\-: Implement custom class inheriting Q\-Cookie\-Jar for loacal storage in order to do single sign on, Also will allow a better way to check for successful login \hypertarget{classHttpManager_ac1e6cdef1723a7b28a348b3046ddfe86}{\index{Http\-Manager@{Http\-Manager}!post\-Credentials@{post\-Credentials}}
\index{post\-Credentials@{post\-Credentials}!HttpManager@{Http\-Manager}}
\subsubsection[{post\-Credentials}]{\setlength{\rightskip}{0pt plus 5cm}void Http\-Manager\-::post\-Credentials (
\begin{DoxyParamCaption}
\item[{Q\-String}]{credentials}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [slot]}}}\label{classHttpManager_ac1e6cdef1723a7b28a348b3046ddfe86}
This method Posts login credentails to server @ vocoloco.\-herokuapp.\-com/login \hypertarget{classHttpManager_a1abaa98249ae82e1742b3ffbcf33fa4f}{\index{Http\-Manager@{Http\-Manager}!post\-New\-Convo@{post\-New\-Convo}}
...
Sends the post request to the server at P\-O\-S\-T /conversations \hypertarget{classHttpManager_ae665ee770c4ee653743a067b9bb8efff}{\index{Http\-Manager@{Http\-Manager}!set\-New\-Message\-Content@{set\-New\-Message\-Content}}
\index{set\-New\-Message\-Content@{set\-New\-Message\-Content}!HttpManager@{Http\-Manager}}
\subsubsection[{set\-New\-Message\-Content}]{\setlength{\rightskip}{0pt plus 5cm}void Http\-Manager\-::set\-New\-Message\-Content (
\begin{DoxyParamCaption}
\item[{Q\-String}]{content, }
\item[{Q\-String}]{id}
\end{DoxyParamCaption}
)}}\label{classHttpManager_ae665ee770c4ee653743a067b9bb8efff}


Sets the content and converstaion id of the message object to be posted. 
...
\hline
\end{DoxyParams}
\hypertarget{classHttpManager_a5a810bffa61e583780bfdaca7e85a9fd}{\index{Http\-Manager@{Http\-Manager}!write\-Audio\-To\-File@{write\-Audio\-To\-File}}
